    ...
    for (var i = dayHourStart; i < dayHourEnd; i++) {
        ...
        for(j = 0; j < 3; j++) {
            ...
            if(j == 0) {
                ...
                plannerRows.append(plannerCols1.addClass("hour border-top border-end border-bottom col-1 d-flex align-items-center justify-content-end").append(hour));
            }
            // Second if: adds the text area column
            else if (j == 1) {

                // Variable to add the second column class from the variable plannerCols2.
                var textAreaCol = plannerCols2.addClass("description p-auto border col-10");
                ...
                var lockDiv = plannerCols3.addClass("saveBtn col-1 border rounded-end d-flex align-items-center justify-content-center");
